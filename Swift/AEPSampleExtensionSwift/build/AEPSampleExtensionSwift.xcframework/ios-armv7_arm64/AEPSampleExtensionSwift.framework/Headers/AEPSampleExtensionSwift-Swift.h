...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AEPSampleExtensionSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("SampleExtension")
...
@interface AEPSampleExtension (SWIFT_EXTENSION(AEPSampleExtensionSwift))
+ (void)getSampleDataListenerExample:(void (^ _Nonnull)(NSString * _Nullable, enum AEPError))completion;
+ (void)setterDataExample:(NSString * _Nonnull)data;
@end
