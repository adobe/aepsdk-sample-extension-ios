...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) id <AEPDataQueuing> _Nonnull shared;)
+ (id <AEPDataQueuing> _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
/// Initialize a <code>DataQueue</code> object
/// \param name the label you assigned to the <code>DataQueue</code> at creation time.
///
///
/// returns:
